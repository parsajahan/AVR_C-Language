...
;DATA STACK POINTER INITIALIZATION
	...
	.CSEG
;/*******************************************************
;Project : moving number positions in aLCD
;Version : 1
;Date    : 10/5/2022
...
;char x,y; // position of number in alcd
;
;
;
;void main(void)
...
; 0000 00A3        lcd_gotoxy(x,y);
	ST   -Y,R5
	MOV  R26,R4
	RCALL _lcd_gotoxy
; 0000 00A4        lcd_putsf("1"); // u can put any number u want
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00A5 
; 0000 00A6        // changing position
; 0000 00A7        x++;
	INC  R5
; 0000 00A8        if (x == 20) {x=0;
	LDI  R30,LOW(20)
	CP   R30,R5
	BRNE _0x6
	CLR  R5
