...
_0x0:
	.DB  0x70,0x61,0x72,0x73,0x61,0x20,0x6A,0x61
	.DB  0x68,0x61,0x6E,0x67,0x69,0x72,0x69,0x20
	.DB  0x70,0x6F,0x75,0x72,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0091 // D4 - PORTA Bit 3
; 0000 0092 // D5 - PORTA Bit 4
; 0000 0093 // D6 - PORTA Bit 5
; 0000 0094 // D7 - PORTA Bit 6
...
; 0000 0097 
; 0000 0098 
; 0000 0099 //** code: using 3 important built in commands
; 0000 009A // 1) clearing lcd
; 0000 009B lcd_clear();
	RCALL _lcd_clear
; 0000 009C 
; 0000 009D // 1) choosing where to start writing in  lcd
; 0000 009E lcd_gotoxy(0,0);
	...
	RCALL _lcd_gotoxy
; 0000 009F 
; 0000 00A0 // writing ur name with this command
; 0000 00A1 lcd_putsf("parsa jahangiri pour"); // in ("") can put any charachter u want
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 00A2 
; 0000 00A3 //////////////////////////////////////////////////////////////////////////////////
