...
;Project : LED_ON&OFF_usinng delay
;Version :
;Date    : 9/29/2022
;
;
...
; 0000 0020 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=Out
; 0000 0021 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 0022 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=0
...
_0x3:
; 0000 0085       {
; 0000 0086        // Regester PORT is used to determine micro conroller output(0v or 5v)
; 0000 0087           PORTA.0=0; // LED off
	CBI  0x1B,0
; 0000 0088           delay_ms(100); // wait 100 ms
	LDI  R26,LOW(100)
	LDI  R27,0
	CALL _delay_ms
; 0000 0089           PORTA.0=1;      // LED ON
	SBI  0x1B,0
; 0000 008A           delay_ms(100);   // wait 100 ms
	LDI  R26,LOW(100)
	LDI  R27,0
	CALL _delay_ms
; 0000 008B       }
