...
;http://www.hpinfotech.com
;
;Project : controlling state of LED using holding method. if key is being pushed for 3 sec or more ,LED wll turn on
;Version : 1
;Date    : 10/3/2022
;Author  : parsa jahangiri pour @parsajahan
;Company :
;Comments: ATmega32 - LED - push button - resistor
;
;
;Chip type               : ATmega32A
;Program type            : Application
...
; 0000 0029 // Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 002A DDRA=(1<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(128)
	OUT  0x1A,R30
; 0000 002B // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 002C PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 002D 
...
_0x3:
; 0000 008E       {
; 0000 008F            while(key == 1);
_0x6:
	SBIC 0x19,0
	RJMP _0x6
; 0000 0090            if (key == 0){ // if key is being pushed
	SBIC 0x19,0
	RJMP _0x9
; 0000 0091 
; 0000 0092             for (i=0; i<3000;i++){
	CLR  R4
	CLR  R5
_0xB:
	LDI  R30,LOW(3000)
...
; 0000 0098            }
; 0000 0099 
; 0000 009A            // check if key was puhed enough
; 0000 009B          if (i == 3000) {
_0x9:
	LDI  R30,LOW(3000)
	LDI  R31,HIGH(3000)
