...
;DATA STACK POINTER INITIALIZATION
	...
	.CSEG
;/*******************************************************
;Project : LED ON&OFF Using 2 Keys
;Version :
;Date    : 9/29/2022
...
;
;
;// defining output to led && input keys
;#define ON PINA.0
;#define OFF PINA.1
;
;#define LED PORTA.7
...
; 0000 0026 DDRA=(1<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(128)
	OUT  0x1A,R30
; 0000 0027 // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=P Bit0=P
; 0000 0028 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(3)
	OUT  0x1B,R30
; 0000 0029 
...
_0x3:
; 0000 008A       {
; 0000 008B           if(ON == 0) LED=1; // if PINA.0 == 0 ---> TURN ON THE LED
	SBIS 0x19,0
	SBI  0x1B,7
; 0000 008C           if(OFF == 0) LED=0; // if PINA.1 == 0 ---> TURN OFF THE LED
	SBIS 0x19,1
	CBI  0x1B,7
; 0000 008D           delay_ms(5); // Adding delay to speed down commands
	LDI  R26,LOW(5)
	LDI  R27,0
	CALL _delay_ms
; 0000 008E       }
