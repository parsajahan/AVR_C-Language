...
;http://www.hpinfotech.com
;
;Project : controling state of LED using one key
;Version :
;Date    : 10/1/2022
...
;Data Stack size         : 512
;*******************************************************/
;// including libaries to the project
;#include <mega32a.h>
...
; 0000 008E    {
; 0000 008F 
; 0000 0090        // key not being pushed
; 0000 0091        LED=0;  // OFF state
	CBI  0x1B,7
; 0000 0092 
; 0000 0093        while ( key == 0) { //pushing the key
_0x8:
	SBIC 0x19,0
	RJMP _0xA
; 0000 0094        LED=1;  // ON state
	SBI  0x1B,7
; 0000 0095        }
	RJMP _0x8
_0xA:
